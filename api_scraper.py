...
class MLB_Scrape:
    ...
    def get_schedule(self,
        ...
        try:
            ...
            game_list = [item for sublist in
                         [[y.get('gamePk', np.nan) for y in x.get('games', [])] for x in game_call.get('dates', [])] for
                         item in sublist]
            time_list = [item for sublist in
                         [[y.get('gameDate', np.nan) for y in x.get('games', [])] for x in game_call.get('dates', [])]
                         for item in sublist]
            date_list = [item for sublist in [[y.get('officialDate', np.nan) for y in x.get('games', [])] for x in
                                              game_call.get('dates', [])] for item in sublist]
            away_team_list = [item for sublist in
                              [[safe_get(y, ['teams', 'away', 'team', 'name'], "") for y in x.get('games', [])] for x in
                               game_call.get('dates', [])] for item in sublist]
            away_team_id_list = [item for sublist in
                                 [[safe_get(y, ['teams', 'away', 'team', 'id'], np.nan) for y in x.get('games', [])] for
                                  x in game_call.get('dates', [])] for item in sublist]
            home_team_list = [item for sublist in
                              [[safe_get(y, ['teams', 'home', 'team', 'name'], "") for y in x.get('games', [])] for x in
                               game_call.get('dates', [])] for item in sublist]
            home_team_id_list = [item for sublist in
                                 [[safe_get(y, ['teams', 'home', 'team', 'id'], np.nan) for y in x.get('games', [])] for
                                  x in game_call.get('dates', [])] for item in sublist]
            state_list = [item for sublist in
                          [[safe_get(y, ['status', 'codedGameState'], "") for y in x.get('games', [])] for x in
                           game_call.get('dates', [])] for item in sublist]
            venue_id = [item for sublist in [[safe_get(y, ['venue', 'id'], np.nan) for y in x.get('games', [])] for x in
                                             game_call.get('dates', [])] for item in sublist]
            venue_name = [item for sublist in [[safe_get(y, ['venue', 'name'], "") for y in x.get('games', [])] for x in
                                               game_call.get('dates', [])] for item in sublist]
            gameday_type = [item for sublist in [[safe_get(y, ['gamedayType'], "") for y in x.get('games', [])] for x in
                                                 game_call.get('dates', [])] for item in sublist]
                        ...
                        if ab_list['playEvents'][n]['isPitch'] == True or 'call' in ab_list['playEvents'][n]['details']:
                            ...
                            if 'matchup' in ab_list:
                                ...
                                if 'batter' in ab_list['matchup']:
                                    batter_name.append(
                                        ab_list['matchup']['batter']['fullName'] if 'fullName' in ab_list['matchup'][
                                            'batter'] else None)
                                else:
                                ...
                                if 'pitcher' in ab_list['matchup']:
                                    pitcher_name.append(
                                        ab_list['matchup']['pitcher']['fullName'] if 'fullName' in ab_list['matchup'][
                                            'pitcher'] else None)
                                else:
                                    pitcher_name.append(None)

                                pitcher_hand.append(ab_list['matchup']['pitchHand']['code'] if 'pitchHand' in ab_list[
                                    'matchup'] else None)

                            if ab_list['about']['isTopInning']:
                                batter_team.append(
                                    data['gameData']['teams']['away']['abbreviation'] if 'away' in data['gameData'][
                                        'teams'] else None)
                                batter_team_id.append(
                                    data['gameData']['teams']['away']['id'] if 'away' in data['gameData'][
                                        'teams'] else None)
                                pitcher_team.append(
                                    data['gameData']['teams']['home']['abbreviation'] if 'home' in data['gameData'][
                                        'teams'] else None)
                                pitcher_team_id.append(
                                    data['gameData']['teams']['home']['id'] if 'home' in data['gameData'][
                                        'teams'] else None)
                            ...
                            play_description.append(
                                ab_list['playEvents'][n]['details']['description'] if 'description' in
                                                                                      ab_list['playEvents'][n][
                                                                                          'details'] else None)
                            play_code.append(
                                ab_list['playEvents'][n]['details']['code'] if 'code' in ab_list['playEvents'][n][
                                    'details'] else None)
                            in_play.append(ab_list['playEvents'][n]['details']['isInPlay'] if 'isInPlay' in
                                                                                              ab_list['playEvents'][n][
                                                                                                  'details'] else None)
                            is_strike.append(ab_list['playEvents'][n]['details']['isStrike'] if 'isStrike' in
                                                                                                ab_list['playEvents'][
                                                                                                    n][
                                                                                                    'details'] else None)
                            ...
                            is_ball.append(
                                ab_list['playEvents'][n]['details']['isOut'] if 'isOut' in ab_list['playEvents'][n][
                                    'details'] else None)
                            is_review.append(ab_list['playEvents'][n]['details']['hasReview'] if 'hasReview' in
                                                                                                 ab_list['playEvents'][
                                                                                                     n][
                                                                                                     'details'] else None)
                            pitch_type.append(ab_list['playEvents'][n]['details']['type']['code'] if 'type' in ab_list[
                                'playEvents'][n]['details'] else None)
                            pitch_description.append(
                                ab_list['playEvents'][n]['details']['type']['description'] if 'type' in
                                                                                              ab_list['playEvents'][n][
                                                                                                  'details'] else None)
                            ...
                            if ab_list['playEvents'][n]['pitchNumber'] == 1:
                                strikes.append(0)
                                balls.append(0)
                                strikes_after.append(ab_list['playEvents'][n]['count']['strikes'] if 'strikes' in
                                                                                                     ab_list[
                                                                                                         'playEvents'][
                                                                                                         n][
                                                                                                         'count'] else None)
                                balls_after.append(
                                    ab_list['playEvents'][n]['count']['balls'] if 'balls' in ab_list['playEvents'][n][
                                        'count'] else None)
                                outs.append(
                                    ab_list['playEvents'][n]['count']['outs'] if 'outs' in ab_list['playEvents'][n][
                                        'count'] else None)
                                outs_after.append(
                                    ab_list['playEvents'][n]['count']['outs'] if 'outs' in ab_list['playEvents'][n][
                                        'count'] else None)
                                ...
                                strikes.append(ab_list['playEvents'][n - 1]['count']['strikes'] if 'strikes' in ab_list[
                                    'playEvents'][n - 1]['count'] else None)
                                balls.append(ab_list['playEvents'][n - 1]['count']['balls'] if 'balls' in
                                                                                               ab_list['playEvents'][
                                                                                                   n - 1][
                                                                                                   'count'] else None)
                                outs.append(ab_list['playEvents'][n - 1]['count']['outs'] if 'outs' in
                                                                                             ab_list['playEvents'][
                                                                                                 n - 1][
                                                                                                 'count'] else None)
                            ...
                            if 'pitchData' in ab_list['playEvents'][n]:
                                ...
                                start_speed.append(
                                    ab_list['playEvents'][n]['pitchData']['startSpeed'] if 'startSpeed' in
                                                                                           ab_list['playEvents'][n][
                                                                                               'pitchData'] else None)
                                end_speed.append(ab_list['playEvents'][n]['pitchData']['endSpeed'] if 'endSpeed' in
                                                                                                      ab_list[
                                                                                                          'playEvents'][
                                                                                                          n][
                                                                                                          'pitchData'] else None)
                                ...
                                sz_top.append(
                                    ab_list['playEvents'][n]['pitchData']['strikeZoneTop'] if 'strikeZoneTop' in
                                                                                              ab_list['playEvents'][n][
                                                                                                  'pitchData'] else None)
                                sz_bot.append(
                                    ab_list['playEvents'][n]['pitchData']['strikeZoneBottom'] if 'strikeZoneBottom' in
                                                                                                 ab_list['playEvents'][
                                                                                                     n][
                                                                                                     'pitchData'] else None)
                                x.append(ab_list['playEvents'][n]['pitchData']['coordinates']['x'] if 'x' in ab_list[
                                    'playEvents'][n]['pitchData']['coordinates'] else None)
                                y.append(ab_list['playEvents'][n]['pitchData']['coordinates']['y'] if 'y' in ab_list[
                                    'playEvents'][n]['pitchData']['coordinates'] else None)

                                ax.append(ab_list['playEvents'][n]['pitchData']['coordinates']['aX'] if 'aX' in ab_list[
                                    'playEvents'][n]['pitchData']['coordinates'] else None)
                                ay.append(ab_list['playEvents'][n]['pitchData']['coordinates']['aY'] if 'aY' in ab_list[
                                    'playEvents'][n]['pitchData']['coordinates'] else None)
                                az.append(ab_list['playEvents'][n]['pitchData']['coordinates']['aZ'] if 'aZ' in ab_list[
                                    'playEvents'][n]['pitchData']['coordinates'] else None)
                                pfxx.append(ab_list['playEvents'][n]['pitchData']['coordinates']['pfxX'] if 'pfxX' in
                                                                                                            ab_list[
                                                                                                                'playEvents'][
                                                                                                                n][
                                                                                                                'pitchData'][
                                                                                                                'coordinates'] else None)
                                pfxz.append(ab_list['playEvents'][n]['pitchData']['coordinates']['pfxZ'] if 'pfxZ' in
                                                                                                            ab_list[
                                                                                                                'playEvents'][
                                                                                                                n][
                                                                                                                'pitchData'][
                                                                                                                'coordinates'] else None)
                                px.append(ab_list['playEvents'][n]['pitchData']['coordinates']['pX'] if 'pX' in ab_list[
                                    'playEvents'][n]['pitchData']['coordinates'] else None)
                                pz.append(ab_list['playEvents'][n]['pitchData']['coordinates']['pZ'] if 'pZ' in ab_list[
                                    'playEvents'][n]['pitchData']['coordinates'] else None)
                                vx0.append(ab_list['playEvents'][n]['pitchData']['coordinates']['vX0'] if 'vX0' in
                                                                                                          ab_list[
                                                                                                              'playEvents'][
                                                                                                              n][
                                                                                                              'pitchData'][
                                                                                                              'coordinates'] else None)
                                vy0.append(ab_list['playEvents'][n]['pitchData']['coordinates']['vY0'] if 'vY0' in
                                                                                                          ab_list[
                                                                                                              'playEvents'][
                                                                                                              n][
                                                                                                              'pitchData'][
                                                                                                              'coordinates'] else None)
                                vz0.append(ab_list['playEvents'][n]['pitchData']['coordinates']['vZ0'] if 'vZ0' in
                                                                                                          ab_list[
                                                                                                              'playEvents'][
                                                                                                              n][
                                                                                                              'pitchData'][
                                                                                                              'coordinates'] else None)
                                x0.append(ab_list['playEvents'][n]['pitchData']['coordinates']['x0'] if 'x0' in ab_list[
                                    'playEvents'][n]['pitchData']['coordinates'] else None)
                                y0.append(ab_list['playEvents'][n]['pitchData']['coordinates']['y0'] if 'y0' in ab_list[
                                    'playEvents'][n]['pitchData']['coordinates'] else None)
                                z0.append(ab_list['playEvents'][n]['pitchData']['coordinates']['z0'] if 'z0' in ab_list[
                                    'playEvents'][n]['pitchData']['coordinates'] else None)

                                zone.append(
                                    ab_list['playEvents'][n]['pitchData']['zone'] if 'zone' in ab_list['playEvents'][n][
                                        'pitchData'] else None)
                                type_confidence.append(
                                    ab_list['playEvents'][n]['pitchData']['typeConfidence'] if 'typeConfidence' in
                                                                                               ab_list['playEvents'][n][
                                                                                                   'pitchData'] else None)
                                plate_time.append(ab_list['playEvents'][n]['pitchData']['plateTime'] if 'plateTime' in
                                                                                                        ab_list[
                                                                                                            'playEvents'][
                                                                                                            n][
                                                                                                            'pitchData'] else None)
                                extension.append(ab_list['playEvents'][n]['pitchData']['extension'] if 'extension' in
                                                                                                       ab_list[
                                                                                                           'playEvents'][
                                                                                                           n][
                                                                                                           'pitchData'] else None)
                                ...
                                if 'breaks' in ab_list['playEvents'][n]['pitchData']:
                                    spin_rate.append(
                                        ab_list['playEvents'][n]['pitchData']['breaks']['spinRate'] if 'spinRate' in
                                                                                                       ab_list[
                                                                                                           'playEvents'][
                                                                                                           n][
                                                                                                           'pitchData'][
                                                                                                           'breaks'] else None)
                                    spin_direction.append(ab_list['playEvents'][n]['pitchData']['breaks'][
                                                              'spinDirection'] if 'spinDirection' in
                                                                                  ab_list['playEvents'][n]['pitchData'][
                                                                                      'breaks'] else None)
                                    vb.append(ab_list['playEvents'][n]['pitchData']['breaks'][
                                                  'breakVertical'] if 'breakVertical' in
                                                                      ab_list['playEvents'][n]['pitchData'][
                                                                          'breaks'] else None)
                                    ivb.append(ab_list['playEvents'][n]['pitchData']['breaks'][
                                                   'breakVerticalInduced'] if 'breakVerticalInduced' in
                                                                              ab_list['playEvents'][n]['pitchData'][
                                                                                  'breaks'] else None)
                                    hb.append(ab_list['playEvents'][n]['pitchData']['breaks'][
                                                  'breakHorizontal'] if 'breakHorizontal' in
                                                                        ab_list['playEvents'][n]['pitchData'][
                                                                            'breaks'] else None)
                            ...
                            if 'hitData' in ab_list['playEvents'][n]:
                                launch_speed.append(
                                    ab_list['playEvents'][n]['hitData']['launchSpeed'] if 'launchSpeed' in
                                                                                          ab_list['playEvents'][n][
                                                                                              'hitData'] else None)
                                launch_angle.append(
                                    ab_list['playEvents'][n]['hitData']['launchAngle'] if 'launchAngle' in
                                                                                          ab_list['playEvents'][n][
                                                                                              'hitData'] else None)
                                launch_distance.append(
                                    ab_list['playEvents'][n]['hitData']['totalDistance'] if 'totalDistance' in
                                                                                            ab_list['playEvents'][n][
                                                                                                'hitData'] else None)
                                launch_location.append(ab_list['playEvents'][n]['hitData']['location'] if 'location' in
                                                                                                          ab_list[
                                                                                                              'playEvents'][
                                                                                                              n][
                                                                                                              'hitData'] else None)

                                trajectory.append(ab_list['playEvents'][n]['hitData']['trajectory'] if 'trajectory' in
                                                                                                       ab_list[
                                                                                                           'playEvents'][
                                                                                                           n][
                                                                                                           'hitData'] else None)
                                hardness.append(ab_list['playEvents'][n]['hitData']['hardness'] if 'hardness' in
                                                                                                   ab_list[
                                                                                                       'playEvents'][n][
                                                                                                       'hitData'] else None)
                                hit_x.append(ab_list['playEvents'][n]['hitData']['coordinates']['coordX'] if 'coordX' in
                                                                                                             ab_list[
                                                                                                                 'playEvents'][
                                                                                                                 n][
                                                                                                                 'hitData'][
                                                                                                                 'coordinates'] else None)
                                hit_y.append(ab_list['playEvents'][n]['hitData']['coordinates']['coordY'] if 'coordY' in
                                                                                                             ab_list[
                                                                                                                 'playEvents'][
                                                                                                                 n][
                                                                                                                 'hitData'][
                            ...
                            start_time.append(
                                ab_list['playEvents'][n]['startTime'] if 'startTime' in ab_list['playEvents'][
                                    n] else None)
                            end_time.append(
                            ...
                            if n == len(ab_list['playEvents']) - 1:
                                ...
                                type_ab.append(
                                    data['liveData']['plays']['allPlays'][ab_id]['result']['type'] if 'type' in
                                                                                                      data['liveData'][
                                                                                                          'plays'][
                                                                                                          'allPlays'][
                                                                                                          ab_id][
                                                                                                          'result'] else None)
                                event.append(
                                    data['liveData']['plays']['allPlays'][ab_id]['result']['event'] if 'event' in
                                                                                                       data['liveData'][
                                                                                                           'plays'][
                                                                                                           'allPlays'][
                                                                                                           ab_id][
                                                                                                           'result'] else None)
                                event_type.append(data['liveData']['plays']['allPlays'][ab_id]['result'][
                                                      'eventType'] if 'eventType' in
                                                                      data['liveData']['plays']['allPlays'][ab_id][
                                                                          'result'] else None)
                                rbi.append(data['liveData']['plays']['allPlays'][ab_id]['result']['rbi'] if 'rbi' in
                                                                                                            data[
                                                                                                                'liveData'][
                                                                                                                'plays'][
                                                                                                                'allPlays'][
                                                                                                                ab_id][
                                                                                                                'result'] else None)
                                away_score.append(data['liveData']['plays']['allPlays'][ab_id]['result'][
                                                      'awayScore'] if 'awayScore' in
                                                                      data['liveData']['plays']['allPlays'][ab_id][
                                                                          'result'] else None)
                                home_score.append(data['liveData']['plays']['allPlays'][ab_id]['result'][
                                                      'homeScore'] if 'homeScore' in
                                                                      data['liveData']['plays']['allPlays'][ab_id][
                                                                          'result'] else None)
                                is_out.append(
                                    data['liveData']['plays']['allPlays'][ab_id]['result']['isOut'] if 'isOut' in
                                                                                                       data['liveData'][
                                                                                                           'plays'][
                                                                                                           'allPlays'][
                                                                                                           ab_id][
                            ...
                            strikes.append(
                                ab_list['playEvents'][n]['count']['balls'] if 'balls' in ab_list['playEvents'][n][
                                    'count'] else None)
                            balls.append(
                                ab_list['playEvents'][n]['count']['strikes'] if 'strikes' in ab_list['playEvents'][n][
                                    'count'] else None)
                            outs.append(ab_list['playEvents'][n]['count']['outs'] if 'outs' in ab_list['playEvents'][n][
                                'count'] else None)
    ...
    def get_players(self, sport_id: int, season: int, game_type: list = ['R']):
        ...
        if game_type_str == 'S':
            ...
            player_data = requests.get(
                url=f'https://statsapi.mlb.com/api/v1/sports/{sport_id}/players?season={season}&gameType=[{game_type_str}]').json()[
                'people']
            ...
            position_list = [x['primaryPosition']['abbreviation'] if 'primaryPosition' in x else None for x in
                             player_data]
